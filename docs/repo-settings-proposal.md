# Repository settings proposal for burin-labs/harn-circleci-connector
...
`harn-circleci-connector` is a Harn connector package for circleci. It is public so that
